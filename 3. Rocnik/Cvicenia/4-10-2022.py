def prve_cvicenie():
    ...
    pesnicka = "Sedí mucha na stene, na stene, na stene. Sedí mucha na stene, sedí a spí.  Sedí a buvinká potvorka " \
               "malinká. Sedí mucha na stene, sedí a spí  Sede meche ne stene ne stene ne stene... "
...
def tretie_cvicenie():
    ...
    if pismenko not in "aeiouyáéíóúý" or len(pismenko) != 1:
    ...
    if len(list_slov) != 2:
        ...
        return print("Nezadal si prave DVE slova!")
    ...
    print(f"V slove '{slovo1}' sa samohlaska '{pismenko}' nachadza {pocet1}krat!\n"
          f"V slove '{slovo2}' sa samohlaska '{pismenko}' nachadza {pocet2}krat!")
